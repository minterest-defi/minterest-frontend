...
function InsuranceDeposit({ account, updateData, api, keyring }) {
	...
	const palletName = 'controller';
	const transactionName = 'depositInsurance';
...
export default connect(mapStateToProps, null)(InsuranceDeposit);
