...
function InsuranceRedeem({ account, updateData, api, keyring }) {
	...
	const transactionName = 'redeemInsurance';
...
export default connect(mapStateToProps, null)(InsuranceRedeem);
